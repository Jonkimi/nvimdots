...
return {
	...
	-- init_options = {
	-- 	vue = {
	-- 		hybridMode = false, -- hybridMode is for vscode 接管模式，vue_ls 3.0.0 之前的版本可用
	-- 	},
	-- },
	settings = {
		vue = {
	...
	-- 		-- Use the standard request method instead of exec_cmd
	...
	-- 		-- ts_client.requests("workspace/executeCommand", )
	-- 		-- ts_client:exec_cmd({
