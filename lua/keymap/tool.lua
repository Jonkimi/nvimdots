...
local mappings = {
	plugins = {
		...
		["i|<C-\\>"] = map_cmd('<Esc><Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=horizontal"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle horizontal"),
		["t|<C-\\>"] = map_cmd('<Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=horizontal"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle horizontal"),
		["n|<A-\\>"] = map_cmd('<Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=vertical"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle vertical"),
		["i|<A-\\>"] = map_cmd('<Esc><Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=vertical"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle vertical"),
		["t|<A-\\>"] = map_cmd('<Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=vertical"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle vertical"),
		["n|<F5>"] = map_cmd('<Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=vertical"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle vertical"),
		["i|<F5>"] = map_cmd('<Esc><Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=vertical"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle vertical"),
		["t|<F5>"] = map_cmd('<Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=vertical"<CR>'):with_noremap():with_silent():with_desc("terminal: Toggle vertical"),
		["n|<A-d>"] = map_cmd('<Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=float"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle float"),
		["i|<A-d>"] = map_cmd('<Esc><Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=float"<CR>')
			:with_noremap()
			:with_silent()
			:with_desc("terminal: Toggle float"),
		["t|<A-d>"] = map_cmd('<Cmd>execute (v:count > 0 ? v:count : "") . "ToggleTerm direction=float"<CR>'):with_noremap():with_silent():with_desc("terminal: Toggle float"),
